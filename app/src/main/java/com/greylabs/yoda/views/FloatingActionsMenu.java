...
//    private FloatingActionsMenu.RotatingDrawable mRotatingDrawable;
...
//    }
//
//    public void setOnFloatingActionsMenuUpdateListener(FloatingActionsMenu.OnFloatingActionsMenuUpdateListener listener) {
...
//            }
//        };
//        this.mAddButton.setId(net.i2p.android.ext.floatingactionbutton.R.id.fab_expand_menu_button);
...
//                    if(var28 != this.mAddButton && var28.getVisibility() != 8) {
...
//                        FloatingActionsMenu.LayoutParams var30 = (FloatingActionsMenu.LayoutParams)var28.getLayoutParams();
...
//                            FloatingActionsMenu.LayoutParams labelParams = (FloatingActionsMenu.LayoutParams)var32.getLayoutParams();
...
//                        FloatingActionsMenu.LayoutParams params = (FloatingActionsMenu.LayoutParams)child.getLayoutParams();
...
//        return new FloatingActionsMenu.LayoutParams(super.generateDefaultLayoutParams());
//    }
//
//    public android.view.ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
//        return new FloatingActionsMenu.LayoutParams(super.generateLayoutParams(attrs));
//    }
//
//    protected android.view.ViewGroup.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
//        return new FloatingActionsMenu.LayoutParams(super.generateLayoutParams(p));
//    }
//
...
//        FloatingActionsMenu.SavedState savedState = new FloatingActionsMenu.SavedState(superState);
//        savedState.mExpanded = this.mExpanded;
//        return savedState;
//    }
//
//    public void onRestoreInstanceState(Parcelable state) {
//        if(state instanceof FloatingActionsMenu.SavedState) {
//            FloatingActionsMenu.SavedState savedState = (FloatingActionsMenu.SavedState)state;
...
//        public static final Creator<FloatingActionsMenu.SavedState> CREATOR = new Creator() {
//            public FloatingActionsMenu.SavedState createFromParcel(Parcel in) {
//                return new FloatingActionsMenu.SavedState(in, null);
//            }
//
//            public FloatingActionsMenu.SavedState[] newArray(int size) {
//                return new FloatingActionsMenu.SavedState[size];
//            }
//        };
//
