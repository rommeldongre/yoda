...
import com.greylabs.ydo.database.MetaData.TableSlot;
import com.greylabs.ydo.database.MetaData.TablePendingStep;
...
import com.greylabs.ydo.utils.WhereConditionBuilder;
...
public class Slot {
    ...
    /**********************************************************************************************/
    private long id;
    private com.greylabs.ydo.enums.TimeBoxWhen when;
    private int time;
    private long goalId;
    ...
    public com.greylabs.ydo.enums.TimeBoxWhen getWhen() {
        return when;
    }

    public void setWhen(com.greylabs.ydo.enums.TimeBoxWhen when) {
        this.when = when;
    }
    /**********************************************************************************************/
    // Constructors
    ...
    public List<Slot> getAll(TimeBox timeBox){
        ...
        if(c.moveToFirst()){
            ...
            do{
                ...
                slot.setWhen(com.greylabs.ydo.enums.TimeBoxWhen.getIntegerToEnumType(c.getInt(c.getColumnIndex(TableSlot.when))));
