...
import com.greylabs.ydo.database.MetaData.TableTimeBox;
...
public class TimeBox implements Serializable{
        ...
        if(c.moveToFirst()){
            do{
                ...
                this.timeBoxOn=new TimeBoxOn(context,
                        com.greylabs.ydo.enums.TimeBoxOn.getIntegerToEnumType(c.getInt(c.getColumnIndex(TableTimeBox.on))));
    ...
    public long save(){
        ...
        values.put(TableTimeBox.on, com.greylabs.ydo.enums.TimeBoxOn.getEnumToIntegerType(this.timeBoxOn.getOnType()));
