package com.greylabs.ydo.utils.colorpicker;
...
//        outerPaint.setColor(getResources().getColor(R.color.gray));
...
//        outerRect.top = 0;
//        outerRect.right = 0;
//        outerRect.bottom = canvas.getHeight();
...
//            outerRect.left = rect.right+2;

            rect.right += cellSize;
//            outerRect.right += cellSize-2;
            ...
            if (isColorSelected && colors[i] == selectedColor) {
                ...
                rect.top = margin+2;
//                outerRect.top = margin+2;

                rect.bottom = canvas.getHeight() - margin;
//                outerRect.bottom = canvas.getHeight() - margin-2;
            }
