...
import com.greylabs.ydo.utils.colorpicker.LineColorPicker;
...
//        int color = colorPicker.getColor();
    ...
    private TimeBox createTimeBoxObjectFromUI() {
        ...
        if (!timeBoxWhenSet.isEmpty() && !timeBoxOnSubValueSet.isEmpty() && timeBoxTill != null && timeBoxOn != null) {
            com.greylabs.ydo.models.TimeBoxWhen timeBoxWhen = new com.greylabs.ydo.models.TimeBoxWhen(this);
            com.greylabs.ydo.models.TimeBoxOn timeBoxOn = new com.greylabs.ydo.models.TimeBoxOn(this, this.timeBoxOn);
