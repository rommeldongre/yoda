...
//                " end ; ";
    ...
    public static class TableSlot{
        ...
        public static final String createTrigger="" +
                ...
                "    where "+"old."+TableSlot.id+" = "+TablePendingStep.pendingStep+"."+TablePendingStep.slotId+" " +
                "    and  ("+TablePendingStep.pendingStep+"."+TablePendingStep.status+" = "+ PendingStep.PendingStepStatus.TODO.ordinal() +" or" +
                " " +" "+TablePendingStep.pendingStep+"."+TablePendingStep.status+" = "+ PendingStep.PendingStepStatus.DOING.ordinal() +")"+
                ...
                " "+" and  "+TablePendingStep.status+" = "+ PendingStep.PendingStepStatus.DOING.ordinal()+"; "+
